...
import cardLinkImg from '../images/card-link.svg'
            ...
            <div className="projects__tabs">
              <button className="projects__tab projects__tab_active">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <text x="0" y="18" fontSize="18" fill="#6c63ff">
                    &lt;/&gt;
                  </text>
                </svg>
              </button>
            ...
            <div className="projects__cards">
              <article className="card">
                <figure className="card__img-container">
                  <img className="card__img" src={mestoImg} alt="" />
                </figure>
                <div className="card__info-container">
                  <h3 className="card__title">Проект место</h3>
                  <p className="card__description">
                    Веб-страница-хранилище карточек юзеров с возможность регистрироваться,
                    авторизовываться, добавлять карточки, удалять, ставить
                    лайки, и менять имя
                  </p>
                  ...
                  <div className="card__links">
                    <a className="card__link" href="#">
                      <img className="card__link-img" src={cardLinkImg} alt="" />
